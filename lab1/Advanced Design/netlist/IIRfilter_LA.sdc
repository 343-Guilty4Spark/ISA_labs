...
# Created by write_sdc on Sun Nov 21 19:12:52 2021
...
create_clock [get_ports CLK]  -name MY_CLK  -period 2.64  -waveform {0 1.32}
...
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {H4[13]}]
